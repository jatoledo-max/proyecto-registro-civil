...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-tv=1cz4bwe=7+7w^yk%mxluinc3dr6r=i2mdbc*iysjq^eo%=j')
...
# Base de datos: usa PostgreSQL en producción, SQLite en local
DATABASES = {
